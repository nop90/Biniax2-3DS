...
//	}
	...
	_Snd.sounds[ 1 ] = Mix_LoadWAV( "romfs:/sound/sfx1.raw" );
	_Snd.sounds[ 2 ] = Mix_LoadWAV( "romfs:/sound/sfx2.raw" );
	_Snd.sounds[ 3 ] = Mix_LoadWAV( "romfs:/sound/sfx3.raw" );
	_Snd.sounds[ 4 ] = Mix_LoadWAV( "romfs:/sound/sfx4.raw" );
	_Snd.sounds[ 5 ] = Mix_LoadWAV( "romfs:/sound/sfx5.raw" );

	_Snd.music[ 0 ] = Mix_LoadMUS( "romfs:/music/biniax_common00.raw" );
	_Snd.music[ 1 ] = Mix_LoadMUS( "romfs:/music/biniax_common01.raw" );
	_Snd.music[ 2 ] = Mix_LoadMUS( "romfs:/music/biniax_common02.raw" );
	_Snd.music[ 3 ] = Mix_LoadMUS( "romfs:/music/biniax_common03.raw" );
	_Snd.music[ 4 ] = Mix_LoadMUS( "romfs:/music/biniax_common04.raw" );
	_Snd.music[ 5 ] = Mix_LoadMUS( "romfs:/music/biniax_common05.raw" );
	_Snd.music[ 6 ] = Mix_LoadMUS( "romfs:/music/biniax_common06.raw" );
	_Snd.music[ 7 ] = Mix_LoadMUS( "romfs:/music/biniax_common07.raw" );
